...
export const CallToActionButton: FC<PropsWithChildren<ButtonProps>> = ({
	children,
	classname,
}) => {
	return (
		<button
			type="button"
			className={twMerge(
				"relative py-2 px-3 text-sm font-medium rounded-lg bg-gradient-to-b from-[#190d2e] to-[#4a208a] shadow-[0px_0px_12px_#8c45ff] flex items-center gap-2",
				classname
			)}
		>
